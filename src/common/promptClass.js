...
import {
 ...
 export var popUp = {
    ...
    emptyChoose: '<p class="tips">未选择竞品，请先选择竞品<br><span style="font-size:14px;">现仅支持单项竞品加权</span></p><div class="cha-btns"><button class="btn hides">确定</button></div>',
     ...
     wantPromptTitle: '<p class="tips"> 标题对加权计划及效果影响较大，是否需优化宝贝标题 </p><div class="cha-btns"><button class="cancel mr_30 btn jugdeItem">忽略</button><button class="btn promptTitle">优化</button></div> ',
     promptTitle: '<p class="head">添加客服领取标题优化教程，按照教程并修改标题，点击下一步</p><img src="https://file.cdn.chaquanzhong.com/wx_contact.jpg" alt="wx"><div class="cha-btns"><button class="cancel mr_30 btn jugdeItem">忽略</button><button class="btn jugdeItem">下一步</button></div>',
    ...
    //  },
     init: function (type, data) {
         ...
         $('.chaqz-info-wrapper.pop .promptTitle', function () { //标题优化
